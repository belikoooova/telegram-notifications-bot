...
class HelpCommandTest {
    ...
    @Mock
    private UserStateService userStateService = mock(UserStateService.class);
    ...
    void setUp() {
        ...
        helpCommand = new HelpCommand(commands, userStateService);
    }
    ...
    void testHelpCommandHandle() {
        ...
        String expectedMessage = CommandHumanReadableMessage.HELP_BEGIN_OF_THE_ANSWER +
            "command1" + CommandHumanReadableMessage.HELP_COMMANDS_SEPARATOR + "Description1" +
            CommandHumanReadableMessage.HELP_LINES_SEPARATOR +
            "command2" + CommandHumanReadableMessage.HELP_COMMANDS_SEPARATOR + "Description2";
